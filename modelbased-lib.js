...
function Draw() {
    ...
    for(i = 0; i < cscope.nodes.length; i++) {
      ...
      label = (n.props["label"] ? n.props["label"] : "");
      d = $("<div id=\"n_" + n.id + "\" class=\"node\" style=\"left:" + n.x + "px;top:" + n.y + "px;\">" + n.props["label"] + "<div class=\"tags\"><ul><li>123</li><li>234</li></ul></div></div>");
      $(d).draggable();
      $(d).click(function(ev) {
        ShowPopup(this.id);
      });
